...
def userinput1():
        ...
        telephone = input(" Telephone number = ")  # used to allow user to enter contact info
    ...
    for line in contact_list:
            ...
            if search.lower() in line:  # if the search is in the line print the entire line also lower forces it into lower case
                ...
                if edit == "yes":
                    ...
                    f.close()
                    contact_list[
                        count] = new_input  # contact_list[count] is the thing holding the data that has been searched
